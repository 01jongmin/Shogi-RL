...
class ParametricRandomPolicy(Policy):
    ...
    def compute_actions(
        ...
        **kwargs
        ...
        #print(type(obs_batch[0]))
        #print("AAKJLJLFKDAJGLFKAJGSLGJASLGJASLKFJALSKFJASLKFJ")
        #print([np.where(obs[:123]==1) for obs in obs_batch])
        return [np.random.choice(np.where(obs[:123]==1)[0], 1)[0] for obs in obs_batch], [], {}
