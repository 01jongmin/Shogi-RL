...
from shogi_dqn_dueling import TorchMaskedActions
...
for iterartion_id in range(50, 10001, 50):
    Agent0 = None
    Agent1 = None
    ...
    with open(params_path_1, "rb") as f:
        ...
        Agent1 = DQNTrainer(env="shogi", config=config1)
        iter_restore = checkpoint1_path + "/checkpoint_" + str(iterartion_id).zfill(6) + "/checkpoint-" + str(iterartion_id)
