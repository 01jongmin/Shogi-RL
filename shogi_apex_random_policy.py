...
if __name__ == "__main__":
    ...
    config["multiagent"]  = {
        "policies": {
            "player_1": PolicySpec(policy_class=None,  # infer automatically from Trainer
                                   observation_space=None,  # infer automatically from env
                                   action_space=None,  # infer automatically from env,  # <- use default class & infer obs-/act-spaces from env.
                                   ),
            "player_0": PolicySpec(policy_class=ParametricRandomPolicy),  # infer obs-/act-spaces from env.
        },
